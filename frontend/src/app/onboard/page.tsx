...
const SKILLS = [
  "Python Basics", "Data Structures", "NumPy Arrays", "SQL Queries",
  "Linear Algebra Basics", "Probability Theory", "Pandas DataFrames",
  "Machine Learning Basics", "Deep Learning Basics", "Statistics",
]
        ...
        <div className="w-full max-w-xl">
          ...
          {step === 1 && (
            <div className="animate-fadeIn card-elevated rounded-2xl p-8">
              <h1 className="text-2xl font-bold text-slate-900 mb-2">What&apos;s your learning goal?</h1>
          ...
          {step === 3 && (
            <div className="animate-fadeIn">
              <div className="card-elevated rounded-2xl p-8 mb-4">
                <h1 className="text-2xl font-bold text-slate-900 mb-2">Self-assess your skills</h1>
                <p className="text-slate-500 text-sm mb-1">
                  Rate your confidence for each skill. Be honest — we&apos;ll validate it with diagnostics.
                </p>
